			      ...
			      unsigned nr_iovecs)
{
	...
	ret = do_register(ring, IORING_REGISTER_BUFFERS, iovecs, nr_iovecs);
	return (ret < 0) ? ret : 0;
}
...
int io_uring_unregister_buffers(struct io_uring *ring)
{
	...
	ret = do_register(ring, IORING_UNREGISTER_BUFFERS, NULL, 0);
	return (ret < 0) ? ret : 0;
}
...
int io_uring_unregister_files(struct io_uring *ring)
{
	...
	ret = do_register(ring, IORING_UNREGISTER_FILES, NULL, 0);
	return (ret < 0) ? ret : 0;
}
...
int io_uring_register_eventfd(struct io_uring *ring, int event_fd)
{
	...
	ret = do_register(ring, IORING_REGISTER_EVENTFD, &event_fd, 1);
	return (ret < 0) ? ret : 0;
}
...
int io_uring_unregister_eventfd(struct io_uring *ring)
{
	...
	ret = do_register(ring, IORING_UNREGISTER_EVENTFD, NULL, 0);
	return (ret < 0) ? ret : 0;
}
...
int io_uring_register_eventfd_async(struct io_uring *ring, int event_fd)
{
	...
	ret = do_register(ring, IORING_REGISTER_EVENTFD_ASYNC, &event_fd, 1);
	return (ret < 0) ? ret : 0;
}
			    ...
			    unsigned int nr_ops)
{
	...
	ret = do_register(ring, IORING_REGISTER_PROBE, p, nr_ops);
	return (ret < 0) ? ret : 0;
}
				   ...
				   unsigned int nr_res)
{
	...
	ret = do_register(ring, IORING_REGISTER_RESTRICTIONS, res, nr_res);
	return (ret < 0) ? ret : 0;
}
...
{
	return do_register(ring, IORING_REGISTER_IOWQ_AFF, mask, cpusz);
}
