...
#define LIBURING_NOLIBC 1

/*
 * arch/$arch/syscall.h may need this, don't put below
 * this LIBURING_NOLIBC check + include.
 */
...
#  else
#    error "The arch currently isn't supported to build liburing without libc"
#  endif
#endif
